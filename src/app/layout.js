...
export const metadata = {
  title: 'Perma Agro Farmland Investment',
  description: 'Farmland investment.diversify your investment portfolio by investing in farmlands in nigeria',
}
      ...
      <body>
        ...
        <footer className={style.footer}>
          <div>
            <div>
              <div>PermaAgro</div>
              <p className={style.address}>12, Ezedigbo
                street,enekwasumpu
                obosi, anambra ,
                Nigeria</p>
              <p>hello@permaagro.com</p>
            </div>
            <div className={style.footer_site_links}>
              <div className={style.navigate_links_wrapper}>
                <h3>Navigate</h3>
                <div className={style.navigate_links}>
                  <Link href='/'>Home</Link>
                  <Link href='/about'>About</Link>
                  <Link href='/farmland_listing'>Farmland Listings</Link>
                  <Link href='/contact'>Contact Us</Link>
                  <Link href='/signup'>Sign Up</Link>
                  <Link href='/login'>Login</Link>
                </div>
              </div>
              <div className={style.resource_links_wrapper}>
                <h3>Resources</h3>
                <div className={style.resource_links}>
                  <Link href='/'>Blog</Link>
          ...
          <div className={style.other_links_wrapper}>
            <div className={style.other_links}>
              <Link href='/'>Terms & Conditions</Link>
              <Link href='/'>Privacy Policy</Link>
              <Link href='/'>Sitemap</Link>
            </div>
            <p>© 2023 PermaAgro Limited. All rights reserved</p>
          </div>
        </footer>
      </body>
    </html>
